...
public sealed class LookAtTheTopCardsOfYourDeckTakeOnePutRestOnBottomEffect : OneShotEffect
{
    ...
    public override void Apply(IGame game)
    {
        ...
        Controller.PutOnTheBottomOfDeckInAnyOrder([.. cards.Where(x => x != card)]);
    }
