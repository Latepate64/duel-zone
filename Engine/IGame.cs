...
public interface IGame
{
    ...
    IEnumerable<ICard> GetChoosableCreaturesControlledByAnyone(IGame game,
        Guid id);
    ...
    IEnumerable<IGameEvent> Move(IAbility ability, ZoneType source,
        ZoneType destination, params ICard[] cards);
    IEnumerable<IGameEvent> MoveTapped(IAbility ability, ZoneType hand,
        ZoneType manaZone, params ICard[] cards);
    ...
    void PutFromShieldZoneToHand(IEnumerable<ICard> cards,
        bool canUseShieldTrigger, IAbility ability);
    ...
    bool CanPlayerUntapTheCardsInTheirManaZoneAtTheStartOfEachOfTheirTurns(
        IPlayer player);
