...
namespace Cards
{
    public static class CardFactory
    {
        ...
        {
            return System.Reflection.Assembly.GetExecutingAssembly().GetTypes().Where(t => t.Namespace != null && t.Namespace.StartsWith("Cards.Cards") && !t.Name.EndsWith("Effect") && !t.Name.EndsWith("Ability") && !t.Name.EndsWith("Filter")).Select(x => Activator.CreateInstance(x)).OfType<Card>();
        }
    }
}
