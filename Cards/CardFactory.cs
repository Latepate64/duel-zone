...
namespace Cards
{
    public static class CardFactory
    {
        ...
        {
            return System.Reflection.Assembly.GetExecutingAssembly().GetTypes().Where(t => t.Namespace.StartsWith("Cards.Cards") && !t.Name.EndsWith("Effect")).Select(x => Activator.CreateInstance(x)).OfType<Card>();
        }
    }
}
