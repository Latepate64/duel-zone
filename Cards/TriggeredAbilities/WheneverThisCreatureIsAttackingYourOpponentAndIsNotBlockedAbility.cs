...
namespace Cards.TriggeredAbilities
{
    class WheneverThisCreatureIsAttackingYourOpponentAndIsNotBlockedAbility : TriggeredAbility
    {
        ...
        {
            return gameEvent is BecomeUnblockedEvent e && e.Attacker.Id == Source && game.CurrentTurn.CurrentPhase is Engine.Steps.AttackPhase a && a.AttackTarget == GetOpponent(game);
        }
