...
namespace Cards.OneShotEffects
{
    class AuraBlastEffect : OneShotEffect, IPowerable
    {
        ...
        {
            game.AddContinuousEffects(Ability, new ContinuousEffects.ThisCreatureGetsPowerAttackerUntilTheEndOfTheTurnEffect(Power, [.. game.BattleZone.GetCreatures(Ability.Controller.Id)]));
        }
