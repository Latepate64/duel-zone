...
namespace Cards.Cards.DM10
{
    ...
    class BombazarDragonOfDestinyEffect : OneShotEffect
    {
        ...
        public override void Apply(IGame game)
        {
            ...
            game.AddDelayedTriggeredAbility(new DelayedTriggeredAbility(new AtTheEndOfTurnAbility(turn.Id, new YouLoseTheGameAtTheEndOfTheExtraTurnEffect()), Ability.Source, Ability.ControllerPlayer, true));
        }
