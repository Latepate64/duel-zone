...
namespace Cards.Cards.DM10
{
    ...
    class PinpointLunatronEffect : OneShotEffects.CardSelectionEffect
    {
        ...
        {
            return game.Players.SelectMany(x => x.ManaZone.Cards).Union(game.BattleZone.GetChoosableCreaturesControlledByPlayer(game, GetOpponent(game).Id)).Union(game.BattleZone.GetCreatures(Ability.Controller));
        }
    }
}
