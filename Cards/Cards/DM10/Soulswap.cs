    ...
    class Soulswap : Spell
    {
        ...
        class SoulswapEffect : OneShotEffect
        {
            ...
            public override void Apply(IGame game)
            {
                ...
                var creatures = game.BattleZone.GetChoosableCreaturesControlledByPlayer(game, Ability.Controller);
                if (creatures.Any())
                {
                    ...
                    if (creature != null)
                    {
                        ...
                        var manas = creature.OwnerPlayer.ManaZone.Creatures.Where(c => !c.IsEvolutionCreature && c.ManaCost <= creature.OwnerPlayer.ManaZone.Cards.Count);
                        if (manas.Any())
                        {
