...
namespace Cards.Cards.DM10
{
    ...
    class IkazTheSpydroidEffect : CardSelectionEffect
    {
        ...
        {
            game.AddDelayedTriggeredAbility(new DelayedTriggeredAbility(new AfterBattleAbility(new IkazTheSpydroidUntapEffect(cards)), Ability.Source, Ability.Controller, true));
        }
