...
namespace Cards.Cards.DM07
{
    ...
    {
        public BattleshipMutantDelayedTriggeredAbility(IAbility source, IEnumerable<ICard> cards) : base(new BattleshipMutantAbility(cards), source.SourceCard, source.Controller, false)
        {
        }
