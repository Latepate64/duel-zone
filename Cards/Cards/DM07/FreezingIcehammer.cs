...
namespace Cards.Cards.DM07
{
    ...
    class FreezingIcehammerEffect : OneShotEffects.ManaFeedEffect
    {
        ...
        {
            return game.BattleZone.GetChoosableCreaturesControlledByPlayer(game, Applier.Opponent.Id).Where(x => x.HasCivilization(Civilization.Water, Civilization.Darkness));
        }
    }
}
