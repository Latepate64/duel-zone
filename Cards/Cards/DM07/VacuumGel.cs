...
namespace Cards.Cards.DM07
{
    ...
    class VacuumGelEffect : DestroyEffect
    {
        ...
        {
            return game.BattleZone.GetChoosableUntappedCreaturesControlledByPlayer(game, Applier.Opponent.Id).Where(x => x.HasCivilization(Civilization.Light, Civilization.Nature));
        }
    }
}
