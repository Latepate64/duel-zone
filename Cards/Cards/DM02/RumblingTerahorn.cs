...
namespace Cards.Cards.DM02
{
    class RumblingTerahorn : Creature
    {
        public RumblingTerahorn() : base("Rumbling Terahorn", 5, Common.Civilization.Nature, 3000, Common.Subtype.HornedBeast)
        {
            ...
            Abilities.Add(new TriggeredAbilities.WhenYouPutThisCreatureIntoTheBattleZoneAbility(new OneShotEffects.SearchDeckEffect(new OwnersDeckCardFilter { CardType = Common.CardType.Creature }, true)));
        }
    }
}
