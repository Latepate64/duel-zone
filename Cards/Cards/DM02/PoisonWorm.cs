namespace Cards.Cards.DM02
{
    class PoisonWorm : Creature
    {
        public PoisonWorm() : base("Poison Worm", 4, Common.Civilization.Darkness, 4000, Common.Subtype.ParasiteWorm)
        {
            ...
            Abilities.Add(new TriggeredAbilities.PutIntoPlayAbility(new OneShotEffects.DestroyEffect(new CardFilters.OwnersBattleZoneMaxPowerCreatureFilter(3000), 1, 1, true)));
        }
    }
}
