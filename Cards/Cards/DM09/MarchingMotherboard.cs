...
namespace Cards.Cards.DM09
{
    ...
    class MarchingMotherboardAbility : WheneverCreatureIsPutIntoTheBattleZoneAbility
    {
        ...
        {
            return card.OwnerPlayer.Id == Controller && card.Id != Source && card.Races.Intersect(new Race[] { Race.CyberCluster, Race.CyberLord, Race.CyberMoon, Race.CyberVirus }).Any();
        }
    }
}
