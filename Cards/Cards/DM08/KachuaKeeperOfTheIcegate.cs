...
namespace Cards.Cards.DM08
{
    ...
    {
        public KachuaDelayedTriggeredAbility(IAbility source, ICard card, Guid turnId) : base(new KachuaAbility(card, turnId), source.SourceCard, source.Controller, true)
        {
        }
    }
