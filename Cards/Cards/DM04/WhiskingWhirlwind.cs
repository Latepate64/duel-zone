...
namespace Cards.Cards.DM04
{
    ...
    class WhiskingWhirlwindEffect : OneShotEffect
    {
        ...
        {
            game.AddDelayedTriggeredAbility(new DelayedTriggeredAbility(new TriggeredAbilities.AtTheEndOfTurnAbility(game.CurrentTurn.Id, new WhiskingWhirlwindUntapEffect()), Ability.SourceCard, Ability.Controller, true));
        }
