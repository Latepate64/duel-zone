...
namespace Cards.Cards.DM03
{
    ...
    class BlazeCannonBuffEffect : OneShotEffect
    {
        ...
        public override void Apply(IGame game)
        {
            ...
            game.AddContinuousEffects(Ability, new ThisCreatureGetsPowerAttackerAndDoubleBreakerUntilTheEndOfTheTurnEffect([.. game.BattleZone.GetCreatures(Ability.Controller.Id)]));
        }
