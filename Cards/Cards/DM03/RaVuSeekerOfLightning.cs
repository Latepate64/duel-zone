namespace Cards.Cards.DM03
{
    class RaVuSeekerOfLightning : Creature
    {
        public RaVuSeekerOfLightning() : base("Ra Vu, Seeker of Lightning", 6, 4000, Common.Subtype.MechaThunder, Common.Civilization.Light)
        {
            ...
            AddAbilities(new TriggeredAbilities.WheneverThisCreatureAttacksAbility(new OneShotEffects.SalvageEffect(new CardFilters.OwnersGraveyardCivilizationSpellFilter(Common.Civilization.Light), 0, 1, true)));
        }
    }
}
