...
namespace Cards.Cards.DM03
{
    ...
    {
        public RaVuSeekerOfLightning() : base("Ra Vu, Seeker of Lightning", 6, 4000, Engine.Subtype.MechaThunder, Engine.Civilization.Light)
        {
    ...
    class RaVuSeekerOfLightningEffect : OneShotEffects.SalvageEffect
    {
        ...
        {
            return source.GetController(game).Graveyard.Spells.Where(x => x.HasCivilization(Engine.Civilization.Light));
        }
    }
}
