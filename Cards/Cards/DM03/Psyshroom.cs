...
namespace Cards.Cards.DM03
{
    class Psyshroom : Creature
    {
        public Psyshroom() : base("Psyshroom", 4, 2000, Common.Subtype.BalloonMushroom, Common.Civilization.Nature)
        {
            ...
            AddAbilities(new TriggeredAbilities.WheneverThisCreatureAttacksAbility(new FromGraveyardIntoManaZoneEffect(new CardFilters.OwnersGraveyardCardFilter(Common.Civilization.Nature), 0, 1, true)));
        }
    }
}
