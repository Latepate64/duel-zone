...
namespace DuelMastersModels.Factories
{
    public static class StaticAbilityFactory
    {
        ...
        public static StaticAbility ParseStaticAbilityForCreature(string text, Creature creature)
        {
            ...
            //ParsedType parsedType = AbilityTypeFactory.GetTypeFromDictionary(text, _staticAbilityDictionaryForCreatures);
            ...
            return parsedType != null
                ? Activator.CreateInstance(parsedType.TypesParsed[0], AbilityTypeFactory.GetInstanceParameters(/*owner, */creature, new Collection<object>(parsed.Objects.Values.ToList()))) as StaticAbility
                : null;
        }
