...
namespace DuelMastersModels.Abilities.StaticAbilities
{
    ...
    internal abstract class StaticAbilityForCreature : StaticAbility
    {
        ...
        protected StaticAbilityForCreature(Cards.ICard source, ContinuousEffect continuousEffect, EffectActivityConditionForCreature effectActivityCondition) : base(source, continuousEffect)
        {
