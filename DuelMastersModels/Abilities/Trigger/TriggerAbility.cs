...
namespace DuelMastersModels.Abilities.TriggerAbilities
{
    ...
    internal class TriggerAbility : NonStaticAbility
    {
        ...
        internal TriggerAbility(TriggerCondition triggerCondition, ReadOnlyOneShotEffectCollection effects, Player controller, Cards.IZoneCard card) : base(effects, controller, card)
        {
