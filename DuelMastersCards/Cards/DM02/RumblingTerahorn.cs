...
namespace Cards.Cards.DM02
{
    class RumblingTerahorn : Creature
    {
        public RumblingTerahorn() : base("Rumbling Terahorn", 5, Civilization.Nature, 3000, Subtype.HornedBeast)
        {
            ...
            Abilities.Add(new TriggeredAbilities.WhenYouPutThisCreatureIntoTheBattleZoneAbility(new OneShotEffects.SearchDeckEffect(new OwnersDeckCardFilter { CardType = CardType.Creature }, true)));
        }
    }
}
