...
namespace DuelMastersCards.Cards.DM02
{
    class PhalEegaDawnGuardian : Creature
    {
        public PhalEegaDawnGuardian() : base("Phal Eega, Dawn Guardian", 5, Civilization.Light, 4000, Subtype.Guardian)
        {
            ...
            Abilities.Add(new TriggeredAbilities.WhenYouPutThisCreatureIntoTheBattleZoneAbility(new OneShotEffects.SalvageEffect(new CardFilters.OwnersGraveyardCardFilter { CardType = CardType.Spell }, 0, 1, true)));
        }
    }
}
